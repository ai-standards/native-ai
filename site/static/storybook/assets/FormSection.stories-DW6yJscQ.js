import{j as e}from"./jsx-runtime-Yb_4y5hn.js";import{R as y}from"./index-BwDkhjyp.js";import{F as le}from"./FormField-_FUo9a1J.js";import"./_commonjsHelpers-BosuxZz1.js";import"./ErrorMessage-BhI4OYJy.js";import"./HelperText-CBAylTSp.js";const s=y.forwardRef(({title:l,description:r,className:U="",children:S,showDivider:f=!1,size:n="md",collapsible:h=!1,defaultCollapsed:Y=!1,collapsed:t,onCollapsedChange:d,...Z},G)=>{const[H,Q]=y.useState(Y),i=t!==void 0?t:H,X=y.useCallback(()=>{const F=!i;t===void 0&&Q(F),d==null||d(F)},[i,t,d]),o={sm:{title:"text-base",description:"text-sm",spacing:"space-y-3",padding:"py-3"},md:{title:"text-lg",description:"text-base",spacing:"space-y-4",padding:"py-4"},lg:{title:"text-xl",description:"text-lg",spacing:"space-y-6",padding:"py-6"}},ee=`
      ${o[n].spacing}
      ${U}
    `,ae=`
      ${l||r?o[n].padding:""}
